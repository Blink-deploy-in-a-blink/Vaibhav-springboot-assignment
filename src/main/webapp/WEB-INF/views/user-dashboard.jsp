...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 10px; text-align: center; color: white; cursor: pointer; transition: transform 0.3s; }
...
<body>
    <div class="container">
        ...
        <div class="user-info">Welcome, ${userEmail}</div>

        <div class="dashboard-cards">
            <div class="card">
                <a href="<c:url value='/user/myBookings'/>">
                    <h3>My Bookings</h3>
